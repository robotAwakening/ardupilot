...
Vector3f AC_AttitudeControl::euler_accel_limit(const Quaternion &att, const Vector3f &euler_accel)
{
    ...
    float sin_phi = constrain_float(fabsf(sinf(phi)), 0.1f, 1.0f);
    float cos_phi = constrain_float(fabsf(cosf(phi)), 0.1f, 1.0f);
    float sin_theta = constrain_float(fabsf(sinf(theta)), 0.1f, 1.0f);
    float cos_theta = constrain_float(fabsf(cosf(theta)), 0.1f, 1.0f);
